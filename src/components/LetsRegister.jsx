    ...
    return (
        <section className='bg-gradient-to-t from-secondary to-primary h-96 flex items-center justify-center font-kanit text-primary font-bold tracking-wider text-3xl'> 
            <div className='container flex justify-center flex-col items-center px-5 text-center'>
                <h2 className='mb-5'>ONLARCA OTOBÜS FİRMASINDAN EN UCUZ BİLETLERİ SATIN ALMAK İÇİN;</h2>
                <button onClick={() => handleForm(true,"register")} className='border-4 py-2 px-4 rounded-md border-primary hover:bg-primary hover:bg-opacity-20'>HEMEN ÜYE OL</button>
            </div>
        </section>
    )
}

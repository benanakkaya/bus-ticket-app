  ...
  return (
    <div className='flex flex-col hidden md:flex w-48 bg-primary p-2 border border-secondary'>
      <div className='border-b border-secondary'>
        <h3 className='m-2 text-lg font-medium '><i className="fa-solid fa-filter text-secondary mr-4"></i> <FormattedMessage id="filters" /></h3>
      </div>
      <form onSubmit={formik.handleSubmit}>
        <div className='my-4 pb-2 border-b border-secondary'>
          <h4 className='mx-2 font-medium'><i className="fa-regular fa-clock text-secondary mr-4"></i><FormattedMessage id="departureTime" /></h4>
          ...
          <div className='flex justify-center items-center gap-x-2'>
            <button className='border border-secondary p-2 rounded-md flex flex-col items-center flex-1'><i className="fa-regular fa-sun text-yellow-400"></i> <FormattedMessage id="am" /></button>
            <button className='border border-secondary p-2 rounded-md flex flex-col items-center flex-1' ><i className="fa-regular fa-moon text-blue-500 "></i> <FormattedMessage id="pm" /> </button>
          </div>
        </div>
        <div className='my-4 pb-2 border-b border-secondary'>
          <h4 className='mx-2 font-medium'><i className="fa-solid fa-chair text-secondary mr-4"></i><FormattedMessage id="seatingArrangement" /></h4>
          <div className='p-2'>
        ...
        <div className='my-4 pb-2 border-b border-secondary'>
          <h4 className='mx-2 font-medium'><i className="fa-solid fa-money-bill text-secondary mr-4"></i> <FormattedMessage id="ticketPrice" /></h4>
          <div className='p-2'>
            <div className='flex justify-center items-center gap-x-3 my-4'>
        ...
        <div className='my-4 pb-2 border-b border-secondary '>
          <h4 className='mx-2 font-medium'><i className="fa-solid fa-copyright text-secondary mr-4"></i> <FormattedMessage id="companies" /></h4>
          <div className='p-2'>
        ...
        <div className='flex justify-center items-center my-2 '>
          <button type='submit' className='border border-secondary text-secondary py-1 px-2 rounded-md'><FormattedMessage id="applyFilter" /></button>
        </div>
      </form>
    </div>
  )
